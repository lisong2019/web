...
* Deep Reinforcement Learning Controlled Intelligent Transportation Systems （强化学习控制技术）
* Simulation and Control Methods for CAVs （自动驾驶控制、场景生成、仿真相关技术）
* Control and Applications for UAVs (无人机应用及控制技术)
* Big Data Analysis (ETC data, EV-related data, UAV videos, GPS trajectory data, safety-related data, etc.) （交通大数据分析、数据管理平台构建）
